...
\begin{figure}
    \includegraphics[scale=0.75]{SI/fig_S3_ktau_potency_leaderboard/SI_potency_leaderboards.png}
...
\begin{figure}
    \includegraphics[scale=0.75]{SI/fig_S2_poses_by_series/success_rate_lead_vs_backup_comparison.png}
