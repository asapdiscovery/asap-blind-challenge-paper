...
\multirow{2}{*}{\includegraphics[scale=0.2]{SI/table_S1_stereoisomer_activity_cliffs/methyl.png}} & R & ASAP-0000733 & 7.87 & 5.97 \\
 & S & ASAP-0000240 & 5.62 & \textless 4.00 \\ \\ \\ \\ 
 \\ \\ \\ 
\multirow{2}{*}{\includegraphics[scale=0.45]{SI/table_S1_stereoisomer_activity_cliffs/benzyl.png}} & R & ASAP-0000526 & 7.30 & 5.21 \\
 & S & ASAP-0000439 & 5.20 & \textless 4.00
\end{tabular}
\caption{Examples of large biochemical potency differences between stereoisomers of compounds involved in this blind challenge. Shown are  diastereomers and their biochemical potencies in both SARS-CoV-2 Mpro and MERS-CoV Mpro. Values noted as \textless 4.0 are below the dynamic range of the assay.}
\end{table}

\newpage
\begin{figure}
    \includegraphics[scale=0.85]{SI/fig_S6_controls_potency_distributions/wis_control_distributions.png}
  \caption{Control compound measurements for the biochemical potency assay used for this challenge. MERS-CoV-Mpro (orange) and SARS-CoV-2 Mpro (blue) measurements for control compound ASAP-0000153 are shown as histograms with a kernel density estimate curve. Both distributions are annotated with their standard deviation from the mean.}
  \label{fgr:biochemical_controls_distributions}
\end{figure}
\newpage

\begin{figure}
    \includegraphics[scale=0.85]{SI/fig_S7_potency_per_chemical_series/potency_performance_per_chemical_series.png}
  \caption{Distributions with kernel density estimate curves of potency prediction error (calculated as the mean absolute error normalized by the dynamic range of the experimental values). Shown are SARS-CoV-2 Mpro (left) and MERS-CoV Mpro (right), with each target's participant entries decomposed over the three chemical series described in the main text of this manuscript.}
  \label{fgr:potency_rae_per_chemical_series}
\end{figure}
\newpage
% \begin{sidewaystable}
% \tiny
