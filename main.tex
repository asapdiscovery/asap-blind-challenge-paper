...
\affiliation{Participants' affiliations}
...
\begin{enumerate}
    ...
    \item \textit{Transparency} % source data, eval, leaderboards and backend code etc all open source
...
% no user-side eval, especially for poses
